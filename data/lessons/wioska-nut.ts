...
export const WIOSKA_NUT_CONTENT: WorldContent = {
  ...
  lessons: [
    ...
    {
      id: "lekcja-10-basowy-dol-nazywanie",
      order: 10,
      difficulty: 3,
      ...
      introClef: "bass",
      exercises: [
        { id: "l10-e1", type: "multiple-choice-notation", difficulty: 3, spec: { type: "multiple-choice-notation", targetNote: "F2", distractorPool: ["G2", "E2", "D2"], clef: "bass" } },
        { id: "l10-e2", type: "multiple-choice-notation", difficulty: 3, spec: { type: "multiple-choice-notation", targetNote: "E2", distractorPool: ["F2", "D2", "G2"], clef: "bass" } },
        { id: "l10-e3", type: "multiple-choice-notation", difficulty: 3, spec: { type: "multiple-choice-notation", targetNote: "D2", distractorPool: ["E2", "C2", "F2"], clef: "bass" } },
        { id: "l10-e4", type: "multiple-choice-notation", difficulty: 3, spec: { type: "multiple-choice-notation", targetNote: "C2", distractorPool: ["D2", "E2", "F2"], clef: "bass" } },
        { id: "l10-e5", type: "pitch-height-choice", difficulty: 2, spec: { type: "pitch-height-choice", targetNote: "C2", correctSide: "low" } },
        { id: "l10-e6", type: "pitch-height-choice", difficulty: 2, spec: { type: "pitch-height-choice", targetNote: "F2", correctSide: "low" } },
      ],
    },
    {
      id: "lekcja-11-basowy-dol-cwiczenia",
      order: 11,
      difficulty: 3,
      introSlides: [{ body: "Te same nuty co przed chwilą — teraz w ruchu." }],
      exercises: [
        { id: "l11-e1", type: "melody-direction-choice", difficulty: 2, spec: { type: "melody-direction-choice", notes: ["G2", "D2", "C2"], correctDirection: "down" } },
        { id: "l11-e2", type: "melody-direction-choice", difficulty: 2, spec: { type: "melody-direction-choice", notes: ["C2", "D2", "G2"], correctDirection: "up" } },
        { id: "l11-e3", type: "note-sequencing", difficulty: 3, spec: { type: "note-sequencing", notes: ["F2", "C2", "E2", "D2"] } },
        { id: "l11-e4", type: "note-word-spelling", difficulty: 3, spec: { type: "note-word-spelling", notes: ["F2", "E2", "D2"] } },
        { id: "l11-e5", type: "clef-trace", difficulty: 2, spec: { type: "clef-trace", clef: "bass" } },
      ],
    },
    {
